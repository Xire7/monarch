  ...
  return (
    <div className="flex flex-col items-center justify-center bg-orange-400 min-h-svh p-16">
      ...
      <div className="flex flex-row space-x-10 items-center font-medium">
        <div className="flex flex-col justify-center items-center p-8 bg-slate-100 rounded-lg space-y-4 w-64 hover:scale-125 transition-transform duration-300 shadow-lg">
        ...
        <div className="flex flex-col items-center p-8 bg-slate-100 rounded-lg space-y-4 w-64 hover:scale-125 transition-transform duration-300 shadow-lg">
